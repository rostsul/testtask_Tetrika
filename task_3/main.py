...
интервалов (IntervalsList). Классы и их методы подробно описаны в документации. Находим пересечение 
...
def appearance(intervals: dict[str, list[int]]) -> int:
    ...
    student: IntervalsList = IntervalsList(intervals.get('pupil', []))
    student.align_intervals_list_by_interval(lesson)
    teacher: IntervalsList = IntervalsList(intervals.get('tutor', []))
    teacher.align_intervals_list_by_interval(lesson)
    student.intersection(teacher)
    return student.sum_intervals()
